...
filepath = tf.keras.utils.get_file('frankenstein.txt', 'https://www.gutenberg.org/cache/epub/84/pg84.txt')
...
char_to_index = dict((c, i) for i, c in enumerate(characters)) # {'a': 1, 'b': 2}
